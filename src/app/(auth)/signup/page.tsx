      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 relative">
        ...
        <div className="relative z-10 w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold tracking-tight">הרשמה</h1>
            <p className="text-gray-400 text-sm mt-1">הרשם ותתחיל לבנות את הבוט שלך</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {(error || localError) && <p className="text-sm text-red-500 text-center">{localError || error}</p>}
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            כבר יש לך חשבון?{' '}
            <Link href="/login" className="text-[#2e90fa] font-medium hover:underline">התחבר</Link>
          </p>
        </div>
      </div>
